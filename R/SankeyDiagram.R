...
#' @param surgeryName
#' @param gapDatesInTherapy
#' @param regimenSankey
#' @keywords sankey
#' @return sankey for regimen and surgery
#' @examples 
#' @import dplyr
#' @import networkD3
#' @import ggplot2
...
sankeyFromEpisode<-function(connectionDetails,
  ...
  ##If regimens apart from each other less than gapDatesInTherapy, collapse using '/'
  ...
  #only data in less than maximum treatment line for visualization 
